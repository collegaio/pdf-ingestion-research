...
CDS_COLUMNS = [
    ...
    Column(
        name="importance_rigor_of_secondary_school_record",
        datatype="string",
        possible_values=["Very Important", "Important", "Considered", "Not Considered"],
    ),
    Column(
        name="importance_class_rank",
        datatype="string",
        possible_values=["Very Important", "Important", "Considered", "Not Considered"],
    ),
    Column(
        name="importance_academic_grade_point_average_gpa",
        datatype="string",
        possible_values=["Very Important", "Important", "Considered", "Not Considered"],
    ),
    Column(
        name="importance_letters_of_recommendation",
        datatype="string",
        possible_values=["Very Important", "Important", "Considered", "Not Considered"],
    ),
    Column(
        name="importance_standardized_test_scores",
        datatype="string",
        possible_values=["Very Important", "Important", "Considered", "Not Considered"],
    ),
    Column(
        name="importance_application_essay",
        datatype="string",
        possible_values=["Very Important", "Important", "Considered", "Not Considered"],
    ),
    Column(
        name="importance_interview",
        datatype="string",
        possible_values=["Very Important", "Important", "Considered", "Not Considered"],
    ),
    Column(
        name="importance_extracurricular_activities",
        datatype="string",
        possible_values=["Very Important", "Important", "Considered", "Not Considered"],
    ),
    Column(
        name="importance_talent_ability",
        datatype="string",
        possible_values=["Very Important", "Important", "Considered", "Not Considered"],
    ),
    Column(
        name="importance_character_personal_qualities",
        datatype="string",
        possible_values=["Very Important", "Important", "Considered", "Not Considered"],
    ),
    Column(
        name="importance_first_generation",
        datatype="string",
        possible_values=["Very Important", "Important", "Considered", "Not Considered"],
    ),
    Column(
        name="importance_alumni_ae_relation",
        datatype="string",
        possible_values=["Very Important", "Important", "Considered", "Not Considered"],
    ),
    Column(
        name="importance_geographical_residence",
        datatype="string",
        possible_values=["Very Important", "Important", "Considered", "Not Considered"],
    ),
    Column(
        name="importance_state_residency",
        datatype="string",
        possible_values=["Very Important", "Important", "Considered", "Not Considered"],
    ),
    Column(
        name="importance_religious_affiliation_commitment",
        datatype="string",
        possible_values=["Very Important", "Important", "Considered", "Not Considered"],
    ),
    Column(
        name="importance_volunteer_work",
        datatype="string",
        possible_values=["Very Important", "Important", "Considered", "Not Considered"],
    ),
    Column(
        name="importance_work_experience",
        datatype="string",
        possible_values=["Very Important", "Important", "Considered", "Not Considered"],
    ),
    Column(
        name="importance_level_of_applicant_interest",
        datatype="string",
        possible_values=["Very Important", "Important", "Considered", "Not Considered"],
    ),
    ...
    Column(
        name="source_of_institutional_control",
        datatype="string",
        possible_values=["Public", "Private"],
    ),
    Column(
        name="classify_your_undergraduate_institution",
        datatype="string",
        possible_values=["Coeducational College", "Men's College", "Women's college"],
    ),
    Column(name="academic_year_calendar", datatype="string"),
    Column(
